...
# you must run settings.py before run this file CramedDataset.py
from scripts.settings import args
...
def load_cremad(args):
    train_csv = './data/CREMAD/train.csv'
    test_csv = './data/CREMAD/test.csv'
